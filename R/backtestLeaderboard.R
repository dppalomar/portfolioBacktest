...
#'@param summary_fun Summary function to be employed (e.g., median or mean).
#'@param show_benchmark Logical value indicating whether to include benchmark in the leaderboard (default is \code{TRUE}).
#'                
#' @return List with the following elements:
#' \item{\code{leaderboard_scores}}{The scores of portfolios in various performance criteria.}
#' \item{\code{leaderboard_performance}}{The detailed performance of portfolios in various performance criteria (coincide with \code{leaderboard_scores}).}
#' \item{\code{error_summary}}{Error message generated by each portfolio. Useful for debugging and give feedback to students.}
#' 
