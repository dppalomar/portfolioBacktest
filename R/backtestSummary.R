...
#'                                       Sharpe ratio, drawdown, turnover rate, computational time, etc.}
#' \item{\code{error}}{Error symbol (\code{TRUE} or \code{FALSE}) of each portfolio over each dataset
...
#'                           Sharpe ratio, drawdown, turnover rate, etc.}
#' \item{\code{error}}{Error symbol (\code{TRUE} or \code{FALSE}) of portfolio over each dataset
#'                    (\code{TRUE} is when the portfolio function generates an error or the maximum cpu time is exceeded).}
...
#' \item{\code{return}}{Portfolio return by portfolio function over each dataset.}
#' \item{\code{cumPnL}}{Portfolio cumulative return by portfolio function over each dataset.}
#' 
#' @author Rui Zhou and Daniel P. Palomar
#' 
#' @examples 
