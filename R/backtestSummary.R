...
backtestSummary <- function(bt, portfolio_indexes = NA, portfolio_names = NA, 
  ...
  performance <- lapply(portfolio_names, function(portfolio_name) backtestSummarySinglePortfolio(res_table, portfolio_name, summary_fun))
...
backtestSummarySinglePortfolio <- function(res_table, portfolio_name, summary_fun) {
  ...
  performance_names[which(performance_names == "cpu_time")] = "cpu time"  # switch from "cpu_time" to "cpu time", to align the name format
  names(performance) = performance_names
