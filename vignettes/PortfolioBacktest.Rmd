...
# Package Snapshot
This package backtests a list of portfolios over multiple datasets on a rolling-window basis, producing final results as the following:
...
backtestTable(bt, c("Uniform", "GMVP", "Markowitz"), 
