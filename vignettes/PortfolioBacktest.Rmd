...
# Quick start
To do the backtest of portoflio, we need load the formated dataset and define the customized portfolio:
```{r, eval = FALSE}
# define the uniform portfolio
portfolio_uniform <- function(dataset, prices = dataset$adjusted) {
  N <- ncol(prices)
  return(rep(1/N, N))
}
...
# do backtest
bt <- portfolioBacktest(portfolio_uniform, dataset)
