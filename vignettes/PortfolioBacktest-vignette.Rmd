...
```{r}
res <- multiplePortfolioBacktest(list(uniform_portfolio_fun, GMVP_portfolio_fun), prices[1:5])
```
...
```{r, cache=TRUE}
res_all_students <- multiplePortfolioBacktest("folder_path", prices[1:3])
