...
Backtesting multiple portfolios is equally simple. It suffices to pass a list of functions to the backtesting function `multiplePortfolioBacktest()`. TBD.
...
Now we can rank the different portfolios/students based on a weighted combination of the performance measures:
```{r, eval=FALSE}
